    ...
    if (t) if (t.Slim = function () {
        ...
        function i(t, e, i, n) {
            if (!(e >= 1)) {
                for (var o = t.width, a = t.height, r = Math.max(n.width, Math.min(i.width, Math.round(t.width * e))), s = Math.max(n.height, Math.min(i.height, Math.round(t.height * e))), h = t, u = null; o > r && a > s;) {
                    ...
                    o = Math.round(.5 * h.width), a = Math.round(.5 * h.height), o < r && (o = r), a < s && (a = s), l.width = o, l.height = a, u = l.getContext("2d"), u.drawImage(h, 0, 0, o, a), _(h), h = l, l = null
                }
                t.width = r, t.height = s, u = t.getContext("2d"), u.drawImage(h, 0, 0, r, s), h !== t && _(h)
            }
        }
        ...
        var u = function () {
            ...
            var s = function (t, i, n) {
                ...
                b = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.msRequestAnimationFrame || function (t) {
                ...
                }, I = {linear: E, ease: P, easeIn: M, easeOut: R}, L = function (t, e) {
                    ...
                    return B(t), {
                        data: t, asCSS: function () {
                            ...
                            return H(t, e), O(i, n, o, a), W(e, i, t), this
                        }, rotateX: function (n) {
                            return H(t, e), z(i, n), W(e, i, t), this
                        }, rotateY: function (n) {
                            return H(t, e), D(i, n), W(e, i, t), this
                        }, rotateZ: function (n) {
                            return H(t, e), A(i, n), W(e, i, t), this
                        }, scale: function (n, o) {
            ...
            function i(t, e, i, r, s, h) {
                var u, l, p, c, d, f, _, m, g, v, y, w, b, k, x, S, C, E, P, M, R, T, I, L, O = t.data, z = h + h + 1,
                    D = r - 1, A = s - 1, N = h + 1, U = N * (N + 1) / 2, B = new n, H = B;
                for (p = 1; p < z; p++) if (H = H.next = new n, p == N) var F = H;
                H.next = B;
                var W = null, q = null;
                _ = f = 0;
                var j = o[h], V = a[h];
                for (l = 0; l < s; l++) {
                    for (S = C = E = P = m = g = v = y = 0, w = N * (M = O[f]), b = N * (R = O[f + 1]), k = N * (T = O[f + 2]), x = N * (I = O[f + 3]), m += U * M, g += U * R, v += U * T, y += U * I, H = B, p = 0; p < N; p++) H.r = M, H.g = R, H.b = T, H.a = I, H = H.next;
                    for (p = 1; p < N; p++) c = f + ((D < p ? D : p) << 2), m += (H.r = M = O[c]) * (L = N - p), g += (H.g = R = O[c + 1]) * L, v += (H.b = T = O[c + 2]) * L, y += (H.a = I = O[c + 3]) * L, S += M, C += R, E += T, P += I, H = H.next;
                    for (W = B, q = F, u = 0; u < r; u++) O[f + 3] = I = y * j >> V, 0 != I ? (I = 255 / I, O[f] = (m * j >> V) * I, O[f + 1] = (g * j >> V) * I, O[f + 2] = (v * j >> V) * I) : O[f] = O[f + 1] = O[f + 2] = 0, m -= w, g -= b, v -= k, y -= x, w -= W.r, b -= W.g, k -= W.b, x -= W.a, c = _ + ((c = u + h + 1) < D ? c : D) << 2, S += W.r = O[c], C += W.g = O[c + 1], E += W.b = O[c + 2], P += W.a = O[c + 3], m += S, g += C, v += E, y += P, W = W.next, w += M = q.r, b += R = q.g, k += T = q.b, x += I = q.a, S -= M, C -= R, E -= T, P -= I, q = q.next, f += 4;
                    _ += r
                }
                for (u = 0; u < r; u++) {
                    for (C = E = P = S = g = v = y = m = 0, f = u << 2, w = N * (M = O[f]), b = N * (R = O[f + 1]), k = N * (T = O[f + 2]), x = N * (I = O[f + 3]), m += U * M, g += U * R, v += U * T, y += U * I, H = B, p = 0; p < N; p++) H.r = M, H.g = R, H.b = T, H.a = I, H = H.next;
                    for (d = r, p = 1; p <= h; p++) f = d + u << 2, m += (H.r = M = O[f]) * (L = N - p), g += (H.g = R = O[f + 1]) * L, v += (H.b = T = O[f + 2]) * L, y += (H.a = I = O[f + 3]) * L, S += M, C += R, E += T, P += I, H = H.next, p < A && (d += r);
                    for (f = u, W = B, q = F, l = 0; l < s; l++) c = f << 2, O[c + 3] = I = y * j >> V, I > 0 ? (I = 255 / I, O[c] = (m * j >> V) * I, O[c + 1] = (g * j >> V) * I, O[c + 2] = (v * j >> V) * I) : O[c] = O[c + 1] = O[c + 2] = 0, m -= w, g -= b, v -= k, y -= x, w -= W.r, b -= W.g, k -= W.b, x -= W.a, c = u + ((c = l + N) < A ? c : A) * r << 2, m += S += W.r = O[c], g += C += W.g = O[c + 1], v += E += W.b = O[c + 2], y += P += W.a = O[c + 3], W = W.next, w += M = q.r, b += R = q.g, k += T = q.b, x += I = q.a, S -= M, C -= R, E -= T, P -= I, q = q.next, f += r
                }
                return t
            }
        ...
        var p = function () {
                ...
                if ("undefined" == typeof t.dataset) {
                    ...
                    for (e in o) o.hasOwnProperty(e) && o[e].name && /^data-[a-z_\-\d]*$/i.test(o[e].name) && (i = g(o[e].name.substr(5)), n[i] = o[e].value);
                    return n
                }
                return t.dataset
            }, g = function (t) {
                ...
                gif: "image/gif",
                bmp: "image/bmp"
            }, S = /(\.png|\.bmp|\.gif|\.jpg|\.jpe|\.jpg|\.jpeg)$/, C = function (t, e) {
                ...
                for (e in x) x.hasOwnProperty(e) && (i = x[e], t.indexOf(i) == -1 && t.push(i));
                return t
            }, H = function (t) {
                return "image/jpeg" === t
            }, F = function (t) {
                var e = void 0;
                for (e in x) if (x.hasOwnProperty(e) && x[e] === t) return e;
                return t
            }, W = function (t) {
                var e = void 0;
                for (e in x) if (x.hasOwnProperty(e) && t.indexOf(x[e]) !== -1) return x[e];
                return null
            }, q = function (t) {
                ...
                return t.getFullYear() + "-" + j(t.getMonth() + 1, "00") + "-" + j(t.getDate(), "00") + "_" + j(t.getHours(), "00") + "-" + j(t.getMinutes(), "00") + "-" + j(t.getSeconds(), "00")
            }, G = function (t) {
                return "undefined" == typeof t.name ? V(new Date) + "." + F(X(t)) : t.name
            }, X = function (t) {
                return t.type || "image/jpeg"
            }, Y = function (t) {
                if ("string" != typeof t) return V(new Date);
                var e = q(t);
            ...
            }, Z = function (t, e, i, n, o, a) {
                t = "" + t + (t.indexOf("?") !== -1 ? "&" : "?") + "url=" + n;
                var r = new XMLHttpRequest;
                r.open("GET", t, !0), e(r), r.responseType = "json", r.onload = function () {
                    return "failure" === this.response.status ? void o(this.response.message) : void K(this.response.body, i, a)
                }, r.send()
            }, K = function (t, e, i, n) {
                ...
                o.open("GET", t, !0), e(o), o.responseType = "blob", o.onload = function (e) {
                    if (o.status >= 200 && o.status < 300 || 0 === o.status && this.response instanceof Blob) {
                        var a = q(t), r = W(this.response.type);
                        S.test(a) || (a += "." + F(r));
                        var s = J(this.response, a);
                        i(yt(s, r))
                ...
                for (var i = Q(t), n = new ArrayBuffer(i.length), o = new Uint8Array(n), a = 0; a < i.length; a++) o[a] = i.charCodeAt(a);
                var r = kt(t);
                return "undefined" == typeof e && (e = V(new Date) + "." + F(r)), J(et(n, r), e)
            }, et = function (t, e) {
                ...
                n.parseMetaData(t, function (a) {
                    ...
                    e && (r.maxWidth = e.width, r.maxHeight = e.height), a.exif && (r.orientation = a.exif.get("Orientation")),
                        n(t, function (t) {
                ...
                var n = arguments.length > 1 && arguments[1] !== e ? arguments[1] : {}, o = arguments[2], a = C("canvas"),
                ...
                if (h) {
                    ...
                    i(a, w, h, l), u.sharpen > 0 && rt(a, ht(u.sharpen))
                }
                o(a)
            }, at = function (t) {
                var e = t.getContext("2d");
                ...
                i.putImageData(e(at(t), t.width, t.height), 0, 0)
            }, st = function (t, e, i) {
                ...
                return function (e, i, n) {
                    for (var o = [0, -1, 0, -1, 5, -1, 0, -1, 0], a = Math.round(Math.sqrt(o.length)), r = .5 * a | 0, s = st(i, n), h = s.data, u = e.data, l = n, p = void 0; l--;) for (p = i; p--;) {
                ...
                var e = vt(t);
                return e.input.file = yt(t.input.file), e.output.image = t.output.image, e
            }, bt = function (t, i, n) {
                if (!t || !i) return null;
                var o = t;
                return "IMG" === t.nodeName && (o = document.createElement("canvas"), o.width = t.width, o.height = t.height, o.getContext("2d").drawImage(t, 0, 0)), o.toDataURL(i, H(i) && "number" == typeof n ? n / 100 : e)
            }, kt = function (t) {
                if (!t) return null;
                ...
                return D("input", i) && !a && (r.input.image = bt(t.input.image, t.input.type)), D("output", i) && (r.output = {
                    name: o ? Y(t.input.name) + "." + o : t.input.name,
                    type: x[o] || t.input.type,
                    width: t.output.width,
                    height: t.output.height
                }, r.output.image = bt(t.output.image, r.output.type, n), r.output.type = kt(r.output.image), "image/png" === r.output.type && (r.output.name = Y(r.input.name) + ".png")), D("actions", i) && (r.actions = vt(t.actions)), r
            }, St = function (t, i, n) {
                var o = t.output.image, a = n ? Y(t.input.name) + "." + n : t.input.name, r = x[n] || t.input.type;
                "image/png" === r && (a = Y(t.input.name) + ".png"), o.toBlob(function (t) {
                    if ("msSaveBlob" in window.navigator) return void window.navigator.msSaveBlob(t, a);
                    var e = (window.URL || window.webkitURL).createObjectURL(t), i = C("a");
                ...
                var a = Rt(t, e, i, o), r = Rt(t, e, i, n), s = o - n <= 180 ? "0" : "1",
                    h = ["M", a.x, a.y, "A", i, i, 0, s, 0, r.x, r.y].join(" ");
                return h
            }, It = function (t, e, i, n) {
                return Tt(t, e, i, 0, 360 * n)
            }, Lt = function () {
                var i = {
                    n: function (t, e, i, n) {
                        var o, a, r, s, h, u, l, p;
                        return r = t.y + t.height, o = z(e.y, 0, r), r - o < i.min.height && (o = r - i.min.height), h = n ? (r - o) / n : t.width, h < i.min.width && (h = i.min.width, o = r - h * n), l = .5 * (h - t.width), s = t.x - l, a = t.x + t.width + l, (s < 0 || Math.round(a) > Math.round(i.width)) && (p = Math.min(t.x, i.width - (t.x + t.width)), s = t.x - p, a = t.x + t.width + p, h = a - s, u = h * n, o = r - u), {
                            x: s,
                            y: o,
                            width: a - s,
                            height: r - o
                        ...
                        var o, a, r, s, h, u, l, p;
                        return o = t.y, r = z(e.y, o, i.height), r - o < i.min.height && (r = o + i.min.height), h = n ? (r - o) / n : t.width, h < i.min.width && (h = i.min.width, r = o + h * n), l = .5 * (h - t.width), s = t.x - l, a = t.x + t.width + l, (s < 0 || Math.round(a) > Math.round(i.width)) && (p = Math.min(t.x, i.width - (t.x + t.width)), s = t.x - p, a = t.x + t.width + p, h = a - s, u = h * n, r = o + u), {
                            x: s,
                            y: o,
                            width: a - s,
                            height: r - o
                        ...
                        var o, a, r, s, h, u, l, p;
                        return s = t.x, a = z(e.x, s, i.width), a - s < i.min.width && (a = s + i.min.width), u = n ? (a - s) * n : t.height, u < i.min.height && (u = i.min.height, a = s + u / n), l = .5 * (u - t.height), o = t.y - l, r = t.y + t.height + l, (o < 0 || Math.round(r) > Math.round(i.height)) && (p = Math.min(t.y, i.height - (t.y + t.height)), o = t.y - p, r = t.y + t.height + p, u = r - o, h = u / n, a = s + h), {
                            x: s,
                            y: o,
                            width: a - s,
                            height: r - o
                        ...
                        var a, r, s, h, n, u, l, p;
                        return r = t.x + t.width, h = z(e.x, 0, r), r - h < i.min.width && (h = r - i.min.width), u = o ? (r - h) * o : t.height, u < i.min.height && (u = i.min.height, h = r - u / o), l = .5 * (u - t.height), a = t.y - l, s = t.y + t.height + l, (a < 0 || Math.round(s) > Math.round(i.height)) && (p = Math.min(t.y, i.height - (t.y + t.height)), a = t.y - p, s = t.y + t.height + p, u = s - a, n = u / o, h = r - n), {
                            x: h,
                            y: a,
                            width: r - h,
                            height: s - a
                        ...
                        var o, a, r, s, h, u, l;
                        return s = t.x, r = t.y + t.height, a = z(e.x, s, i.width), a - s < i.min.width && (a = s + i.min.width), u = n ? (a - s) * n : z(r - e.y, i.min.height, r), u < i.min.height && (u = i.min.height, a = s + u / n), o = t.y - (u - t.height), (o < 0 || Math.round(r) > Math.round(i.height)) && (l = Math.min(t.y, i.height - (t.y + t.height)), o = t.y - l, u = r - o, h = u / n, a = s + h), {
                            x: s,
                            y: o,
                            width: a - s,
                            height: r - o
                        ...
                        var o, a, r, s, h, u, l;
                        return s = t.x, o = t.y, a = z(e.x, s, i.width), a - s < i.min.width && (a = s + i.min.width), u = n ? (a - s) * n : z(e.y - t.y, i.min.height, i.height - o), u < i.min.height && (u = i.min.height, a = s + u / n), r = t.y + t.height + (u - t.height), (o < 0 || Math.round(r) > Math.round(i.height)) && (l = Math.min(t.y, i.height - (t.y + t.height)), r = t.y + t.height + l, u = r - o, h = u / n, a = s + h), {
                            x: s,
                            y: o,
                            width: a - s,
                            height: r - o
                        ...
                        var o, a, r, s, h, u, l;
                        return a = t.x + t.width, o = t.y, s = z(e.x, 0, a), a - s < i.min.width && (s = a - i.min.width), u = n ? (a - s) * n : z(e.y - t.y, i.min.height, i.height - o), u < i.min.height && (u = i.min.height, s = a - u / n), r = t.y + t.height + (u - t.height), (o < 0 || Math.round(r) > Math.round(i.height)) && (l = Math.min(t.y, i.height - (t.y + t.height)), r = t.y + t.height + l, u = r - o, h = u / n, s = a - h), {
                            x: s,
                            y: o,
                            width: a - s,
                            height: r - o
                        ...
                        var o, a, r, s, h, u, l;
                        return a = t.x + t.width, r = t.y + t.height, s = z(e.x, 0, a), a - s < i.min.width && (s = a - i.min.width), u = n ? (a - s) * n : z(r - e.y, i.min.height, r), u < i.min.height && (u = i.min.height, s = a - u / n), o = t.y - (u - t.height), (o < 0 || Math.round(r) > Math.round(i.height)) && (l = Math.min(t.y, i.height - (t.y + t.height)), o = t.y - l, u = r - o, h = u / n, s = a - h), {
                            x: s,
                            y: o,
                            width: a - s,
                            height: r - o
                ...
                return function () {
                    ...
                    return p(n, [{
                        key: "_init", value: function () {
                            ...
                            var o = C("button", "c");
                            this._element.appendChild(o), E(document, k.DOWN, this)
                        }
                    }, {
                        ...
                        key: "resize", value: function (t, e, i, n) {
                            this._interaction = null, this._rect = {
                                x: z(t, 0, this._space.width - this._minWidth),
                                y: z(e, 0, this._space.height - this._minHeight),
                                width: z(i, this._minWidth, this._space.width),
                                height: z(n, this._minHeight, this._space.height)
                            }, this._rectChanged = !0, this._redraw(), this._element.dispatchEvent(new CustomEvent("change"))
                        }
                    }, {
                        ...
                        key: "_onStartDrag", value: function (t) {
                            this._element.contains(t.target) && (t.preventDefault(), E(document, k.MOVE, this), E(document, k.UP, this), this._interaction = {
                        ...
                        key: "_onDrag", value: function (t) {
                            t.preventDefault();
                            var e = T(t), n = this._interaction.type;
                            "c" === n ? (this._rect.x = z(e.x - this._interaction.offset.x, 0, this._space.width - this._rect.width), this._rect.y = z(e.y - this._interaction.offset.y, 0, this._space.height - this._rect.height)) : i[n] && (this._rect = i[n](this._rect, {
                                x: e.x - this._space.x,
                                y: e.y - this._space.y
                            }, {
                                x: 0,
                        ...
                        key: "_onStopDrag", value: function (t) {
                            t.preventDefault(), P(document, k.MOVE, this), P(document, k.UP, this), this._interaction = null, this._element.setAttribute("data-dragging", "false"), this._element.dispatchEvent(new CustomEvent("change"))
                        }
                    }, {
                        ...
                        key: "destroy", value: function () {
                            this._interaction = !1, this._rectChanged = !1, P(document, k.DOWN, this), P(document, k.MOVE, this), P(document, k.UP, this), Pt(this._element)
                        }
                    }, {
                ...
                var i = ["input", "change"], n = function () {
                    ...
                    return p(n, [{
                        key: "_init", value: function () {
                            var t = this;
                            this._element.className = "slim-image-editor", this._container = C("div", "slim-container"), this._wrapper = C("div", "slim-wrapper"), this._stage = C("div", "slim-stage"), this._container.appendChild(this._stage), this._cropper = new Lt, i.forEach(function (e) {
                                t._cropper.element.addEventListener(e, t)
                            }), this._stage.appendChild(this._cropper.element), this._previewWrapper = C("div", "slim-image-editor-preview slim-crop-preview"), this._previewBlurred = C("canvas", "slim-crop-blur"), this._previewWrapper.appendChild(this._previewBlurred), this._wrapper.appendChild(this._previewWrapper), this._previewMask = C("div", "slim-crop-mask"), this._preview = C("img"), this._previewMask.appendChild(this._preview), this._cropper.element.appendChild(this._previewMask), this._btnGroup = C("div", "slim-editor-btn-group"), n.Buttons.forEach(function (e) {
                                var i = L(e), n = t._options["button" + i + "Label"],
                                    o = t._options["button" + i + "Title"], a = t._options["button" + i + "ClassName"],
                                    r = C("button", "slim-editor-btn slim-btn-" + e + (a ? " " + a : ""));
                            ...
                            }), this._utilsGroup = C("div", "slim-editor-utils-group");
                            var e = C("button", "slim-editor-utils-btn slim-btn-rotate" + (this._options.buttonRotateClassName ? " " + this._options.buttonRotateClassName : ""));
                        ...
                        key: "_confirm", value: function () {
                            if (!this._rotating) {
                                var t = this._wrapperRotation % 180 !== 0, e = this._cropper.area,
                                    i = _t(e, t ? this._input.height : this._input.width, t ? this._input.width : this._input.height);
                        ...
                        key: "_rotate", value: function () {
                            ...
                            if (!this._rotating) {
                                ...
                                e && R(e, 90), this._updateWrapperScale(), this._hideCropper(), u(this._previewWrapper, {
                        ...
                        key: "open", value: function (t, e, i, n, o) {
                            ...
                            var r = this._wrapperRotation % 180 !== 0,
                                s = mt(i, r ? t.height : t.width, r ? t.width : t.height);
                            this._preview.onload = function () {
                                a._preview.onload = null, a._cropper.ratio = a.ratio, a._redraw(), a._redrawCropper(s), o(), a._element.style.opacity = ""
                            };
                            var h = lt(this._input, Math.min(this._container.offsetWidth / this._input.width, this._container.offsetHeight / this._input.height) * this._options.devicePixelRatio);
                        ...
                        key: "_redrawCropper", value: function (t) {
                            ...
                            p = t ? {
                                ...
                                width: t.width * s,
                                height: t.height * h
                            } : nt(s, h, this._ratio || h / s), this._cropper.resize(p.x, p.y, p.width, p.height)
                        }
                    }, {
                        key: "_redraw", value: function () {
                            ...
                            this._wrapper.style.cssText = "\n\t\t\t\tleft:" + a + "px;\n\t\t\t\ttop:" + r + "px;\n\t\t\t\twidth:" + n + "px;\n\t\t\t\theight:" + o + "px;\n\t\t\t", this._previewBlurred.style.cssText = "\n\t\t\t\twidth:" + n + "px;\n\t\t\t\theight:" + o + "px;\n\t\t\t", this._preview.style.cssText = "\n\t\t\t\twidth:" + n + "px;\n\t\t\t\theight:" + o + "px;\n\t\t\t", this._previewSize = {
                                width: n,
                                height: o
                            }, this._blurredPreview || (this._previewBlurred.width = 300, this._previewBlurred.height = this._previewBlurred.width * t, ct(this._input, this._previewBlurred), dt(this._previewBlurred, 3), this._blurredPreview = !0)
                        }
                    }, {
                        ...
                        key: "destroy", value: function () {
                            var t = this;
                            Et(this._btnGroup.children).forEach(function (e) {
                                e.removeEventListener("click", t)
                            }), i.forEach(function (e) {
                                t._cropper.element.removeEventListener(e, t)
                            }), this._cropper.destroy(), this._previewBlurred && (this._previewBlurred.width = 1, this._previewBlurred.height = 1), this._element.parentNode && Pt(this._element)
                        }
                    }, {
                ...
                return function () {
                    ...
                    return p(n, [{
                        ...
                        key: "_onDrop", value: function (t) {
                            ...
                            this._element.dispatchEvent(new CustomEvent("file-drop", {detail: y(t)})), this._element.dispatchEvent(new CustomEvent("change")), this._dragPath = null
                        }
                    }, {
                        key: "_onDragOver", value: function (t) {
                            ...
                            return null === e || e ? (this._dragPath || (this._dragPath = []), this._dragPath.push(y(t)), void this._element.dispatchEvent(new CustomEvent("file-over", {
                                detail: {
                        ...
                        key: "_onDragLeave", value: function (t) {
                            this._element.dispatchEvent(new CustomEvent("file-out", {detail: y(t)})), this._dragPath = null
                        }
                    }, {
                        key: "destroy", value: function () {
                            var t = this;
                            ...
                            }), Pt(this._element), this._element = null, this._dragPath = null, this._accept = null
                        }
                    }, {
                        key: "element", get: function () {
                            return this._element
                ...
                return function () {
                    ...
                    return p(i, [{
                        key: "_init", value: function () {
                            this._element = C("div", "slim-popover"), this._element.setAttribute("data-state", "off"), document.body.appendChild(this._element), this._element.addEventListener("touchmove", function (t) {
                                t.preventDefault()
                            }, !0)
                        }
                    }, {
                        ...
                        key: "hide", value: function () {
                            ...
                            u(this._element, {
                                fromOpacity: 1, opacity: 0, duration: 500, complete: function () {
                                    N(t._element), t._element.setAttribute("data-state", "off"), i()
                                }
                            })
                        }
                    }, {
            ...
            }, Ut = {AUTO: "auto", INITIAL: "initial", MANUAL: "manual"}, Bt = ["x", "y", "width", "height"],
            Ht = ["file-invalid-drop", "file-invalid", "file-drop", "file-over", "file-out", "click"],
            Ft = ["cancel", "confirm"], Wt = ["remove", "edit", "download", "upload"], qt = null, jt = 0,
            ...
            Gt = '\n<div class="slim-upload-status"></div>\n', Xt = function (t) {
                ...
                return p(i, [{
                    key: "setRotation", value: function (t, e) {
                        if ("number" == typeof t || t % 90 === 0) {
                            ...
                            if (this._data.input.image) {
                                ...
                                this._data.actions.crop = nt(n, o, this._ratio), this._data.actions.crop.type = Ut.AUTO
                            }
                    ...
                    key: "setSize", value: function (t, e) {
                        "string" == typeof t && (t = Xt(t)), t && t.width && t.height && (this._options.size = vt(t), this._data.actions.size = vt(t), this._data.input.image && e && this._manualTransform(e))
                    }
                }, {
                    key: "setForceSize", value: function (t, e) {
                        "string" == typeof t && (t = Xt(t)), t && t.width && t.height && (this._options.size = vt(t), this._options.forceSize = vt(t), this._data.actions.size = vt(t), this.setRatio(this._options.forceSize.width + ":" + this._options.forceSize.height, e));
                    }
                }, {
                    key: "setRatio", value: function (t, e) {
                        var i = this;
                        if (t && "string" == typeof t && (this._options.ratio = t, this._isFixedRatio())) {
                            var n = At(this._options.ratio, ":");
                            this._ratio = n[1] / n[0], this._data.input.image && e ? this._cropAuto(function (t) {
                                i._scaleDropArea(i._ratio), e && e(t)
                            }) : (this._data.input.image && (this._data.actions.crop = nt(this._data.input.image.width, this._data.input.image.height, this._ratio), this._data.actions.crop.type = Ut.AUTO), this._scaleDropArea(this._ratio), e && e(null))
                        }
                    }
                }, {
                    ...
                    key: "_toggleButton", value: function (t, e) {
                        Ct('.slim-btn[data-action="' + t + '"]', e, this._element)
                    }
                }, {
                    ...
                    key: "_resetData", value: function () {
                        if (this._data.input && this._data.output) {
                            ...
                            t && "CANVAS" === t.nodeName && _(t), e && "CANVAS" === e.nodeName && _(e)
                        }
                        this._data = {
                            server: null,
                            meta: vt(this._options.meta),
                        ...
                        }, this._output && (this._output.value = ""), gt(this._getFileInput())
                    }
                }, {
                    key: "_init", value: function () {
                        var t = this;
                        ...
                        } else this._output = C("input"), this._output.type = "hidden", this._output.name = this._input.name || this._options.defaultInputName, this._element.appendChild(this._output);
                        this._input.removeAttribute("name");
                        var o = C("div", "slim-area"), a = this._getInitialImage(), r = (a || {}).src,
                        ...
                        if (this._isImageOnly()) o.innerHTML = "\n\t\t\t\t" + Vt + "\n\t\t\t\t" + Gt + "\n\t\t\t\t" + h + '\n\t\t\t\t<div class="slim-status"><div class="slim-label-loading">' + (this._options.labelLoading || "") + "</div></div>\n\t\t\t"; else {
                            ...
                            this._input.hasAttribute("accept") && "image/*" !== this._input.getAttribute("accept") ? u = this._input.accept.split(",").map(function (t) {
                                ...
                                return t.length > 0
                            }) : (u = B(), this._input.setAttribute("accept", u.join(","))), this._imageHopper = new zt, this._imageHopper.accept = u, this._imageHopper.allowURLs = "string" == typeof this._options.fetcher, this._element.appendChild(this._imageHopper.element), Ht.forEach(function (e) {
                                t._imageHopper.element.addEventListener(e, t)
                            }), o.innerHTML = "\n\t\t\t\t" + Vt + "\n\t\t\t\t" + Gt + '\n\t\t\t\t<div class="slim-drip"><span><span></span></span></div>\n\t\t\t\t<div class="slim-status"><div class="slim-label">' + (this._options.label || "") + '</div><div class="slim-label-loading">' + (this._options.labelLoading || "") + "</div></div>\n\t\t\t\t" + h + "\n\t\t\t", this._input.addEventListener("change", this)
                        }
                        if (this._element.appendChild(o), this._btnGroup = C("div", "slim-btn-group"), this._btnGroup.style.display = "none", this._element.appendChild(this._btnGroup), Wt.filter(function (e) {
                            return t._isButtonAllowed(e)
                        }).forEach(function (e) {
                            var i = L(e), n = t._options["button" + i + "Label"],
                                o = t._options["button" + i + "Title"] || n, a = t._options["button" + i + "ClassName"],
                                r = C("button", "slim-btn slim-btn-" + e + (a ? " " + a : ""));
                            r.innerHTML = n, r.title = o, r.type = "button", r.addEventListener("click", t), r.setAttribute("data-action", e), t._btnGroup.appendChild(r)
                        }), this._isFixedRatio()) {
                            var l = At(this._options.ratio, ":");
                    ...
                    key: "_updateProgress", value: function (t) {
                        if (t = Math.min(.99999, t), this._element && this._progressEnabled) {
                            ...
                            if (e) {
                                ...
                                .5 * i < o || (n[0].setAttribute("d", It(.5 * i, .5 * i, .5 * i - o, .9999)), n[1].setAttribute("d", It(.5 * i, .5 * i, .5 * i - o, t)))
                            }
                        }
                    }
                }, {
                    ...
                    key: "_throwError", value: function (t) {
                        ...
                        e || (e = C("div", "slim-error"), this._element.querySelector(".slim-status").appendChild(e)), e.innerHTML = t, this._options.didThrowError.apply(this, [t])
                    }
                }, {
                    ...
                    key: "_onInvalidFile", value: function () {
                        var t = this._imageHopper.accept.map(F),
                    ...
                    key: "_load", value: function (t, i) {
                        ...
                        if (!this._isBeingDestroyed) {
                            ...
                            if ("string" == typeof t) return void ($(t) ? this._load(tt(t), i, o) : (a(), K(t, this._options.willLoad, function (t) {
                                n._load(t, i, o)
                            }, function (t) {
                                setTimeout(function () {
                            ...
                            if ("undefined" != typeof t.remote) return $(t.remote) ? void this._load(tt(t.remote), i, o) : void (this._options.fetcher && Z(this._options.fetcher, this._options.willFetch, this._options.willLoad, t.remote, function (t) {
                            ...
                            this._imageEditor && this._imageEditor.dirty(), this._data.input.name = o && o.name ? o.name : G(s), this._data.input.type = X(s), this._data.input.size = s.size, this._data.input.file = s;
                            var h = this._options.internalCanvasSize;
                            f() && (h = this._options.internalCanvasSizeLowMemory), it(s, h, function (t, e) {
                                var a = function () {
                                ...
                                if (!ft(t, n._options.minSize)) return a(), n._onImageTooSmall(), void (i && i.apply(n, ["image-too-small"]));
                            ...
                            var r = function () {
                                o._options.size && (o._data.actions.size = {
                                    ...
                                    var h = "auto" === o._options.devicePixelRatio ? window.devicePixelRatio : o._options.devicePixelRatio,
                                        u = lt(t, r * h);
                                    a.src = "", a.src = u.toDataURL(), _(u), u = null, a.onload = function () {
                                        a.onload = null, o._isBeingDestroyed || e && e(s)
                                    }
                                })
                            };
                            this._initialCrop ? (this._data.actions.crop = vt(this._initialCrop), this._data.actions.crop.type = Ut.INITIAL, this._initialCrop = null, r()) : this._options.willCropInitial.apply(this, [this.data, function (e) {
                                e ? (o._data.actions.crop = e, o._data.actions.crop.type = Ut.INITIAL) : (o._data.actions.crop = nt(a ? t.height : t.width, a ? t.width : t.height, o._ratio), o._data.actions.crop.type = Ut.AUTO), r()
                            }, this])
                        }
                    }
                }, {
                    key: "_applyTransforms", value: function (t, e) {
                        var i = this;
                        this._data.output.image && _(this._data.output.image);
                        var n = vt(this._data.actions);
                        n.filters = {sharpen: this._options.filterSharpen / 100}, this._options.forceMinSize ? n.minSize = this._options.minSize : n.minSize = {
                            width: 0,
                            height: 0
                        }, ot(t, n, function (t) {
                            var n = t;
                            if (i._options.forceSize || i._options.size && 1 == ut(i._options.size, t)) {
                                n = C("canvas"), n.width = i._options.size.width, n.height = i._options.size.height;
                                var o = n.getContext("2d");
                                o.drawImage(t, 0, 0, i._options.size.width, i._options.size.height), _(t)
                            }
                            if (i._options.forceMinSize && i._options.size && i._options.minSize.width === i._options.size.width && i._options.minSize.height === i._options.size.height && (n.width < i._options.minSize.width || n.height < i._options.minSize.height)) {
                                ...
                                n = C("canvas"), n.width = a, n.height = r;
                                var s = n.getContext("2d");
                                s.drawImage(t, 0, 0, a, r), _(t)
                            }
                            if (i._options.forceMinSize && 1 === i._ratio && (n.width < i._options.minSize.width || n.height < i._options.minSize.height)) {
                                n = C("canvas"), n.width = i._options.minSize.width, n.height = i._options.minSize.height;
                                var h = n.getContext("2d");
                                h.drawImage(t, 0, 0, n.width, n.height), _(t)
                            }
                    ...
                    key: "_appendEditor", value: function () {
                        var t = this;
                        this._imageEditor || (this._imageEditor = new Ot(C("div"), {
                    ...
                    key: "_onConfirm", value: function (t) {
                        ...
                        i ? this._startProgress(function () {
                            ...
                            var r = "auto" === e._options.devicePixelRatio ? window.devicePixelRatio : e._options.devicePixelRatio,
                                s = lt(t, o.offsetWidth / t.width * r);
                            o.src = "", o.src = s.toDataURL(), _(s), s = null, o.onload = function () {
                    ...
                    key: "_cropAuto", value: function () {
                        var t = arguments.length > 0 && arguments[0] !== e ? arguments[0] : function (t) {
                            ...
                            n = nt(i ? this._data.input.image.height : this._data.input.image.width, i ? this._data.input.image.width : this._data.input.image.height, this._ratio);
                    ...
                    key: "_manualTransform", value: function (t) {
                        ...
                        this._startProgressLoop(), this._addState("busy"), this._applyTransforms(this._data.input.image, function (i) {
                            ...
                            var r = "auto" === e._options.devicePixelRatio ? window.devicePixelRatio : e._options.devicePixelRatio,
                                s = lt(i, o.offsetWidth / i.width * r);
                            o.src = "", o.src = s.toDataURL(), _(s), s = null, o.onload = function () {
                            ...
                            var o = i._element.querySelector(".slim-upload-status"), a = i._options.willRequest,
                                r = function (t, e) {
                                    ...
                                    var a = setTimeout(function () {
                                        Yt(i._timers, a), o.innerHTML = n, o.setAttribute("data-state", "error"), o.style.opacity = 1
                                    }, 250);
                                    i._timers.push(a), e(t)
                                };
                            "string" == typeof i._options.service ? A(i._options.service, i._options.uploadMethod, n, a, r, s, h) : "function" == typeof i._options.service && i._options.service.apply(i, ["file" === i._options.serviceFormat ? t : n, r, s, h, i])
                        }, t)
                    }
                }, {
                    key: "requestOutput", value: function (t, e) {
                        ...
                        return this._data.input.file ? (e || (e = this.dataBase64), void n.parseMetaData(this._data.input.file, function (o) {
                            ...
                            if (D("input", i._options.post) && (a.push(i._data.input.file), r.append(i._inputReference, i._data.input.file, i._data.input.file.name)), D("output", i._options.post) && null !== i._data.output.image && i._options.uploadBase64 === !1) {
                                var s = tt(e.output.image, e.output.name);
                                if (o.imageHead && i._options.copyImageHead) try {
                                    s = new Blob([o.imageHead, n.blobSlice.call(s, 20)], {type: kt(e.output.image)}), s = J(s, e.output.name)
                                } catch (h) {
                                }
                                a.push(s);
                    ...
                    key: "_showEditor", value: function () {
                        qt.className = this._options.popoverClassName, qt.show(), this._imageEditor.show()
                    }
                }, {
                    ...
                    key: "_doDownload", value: function () {
                        ...
                        t && St(this._data, this._options.jpegCompression, this._options.forceType)
                    }
                }, {
                    key: "_doDestroy", value: function () {
                        ...
                        }), this._imageHopper.destroy(), this._imageHopper = null), this._imageEditor && (Ft.forEach(function (t) {
                            e._imageEditor.element.removeEventListener(t, e)
                        }), this._imageEditor.destroy(), this._imageEditor = null), Et(this._btnGroup.children).forEach(function (t) {
                        ...
                        }), jt = Math.max(0, jt - 1), qt && 0 === jt && (qt.destroy(), qt = null);
                        var n = this._data.input.image, o = this._data.output.image;
                        n && "CANVAS" === n.nodeName && _(n), o && "CANVAS" === o.nodeName && _(o), this._originalElement = null, this._element = null, this._input = null, this._output = null, this._btnGroup = null, this._options = null
                    }
                }, {
                    key: "dataBase64", get: function () {
                        return xt(this._data, this._options.post, this._options.jpegCompression, this._options.forceType, null !== this._options.service)
                    }
                }, {
                    key: "data", get: function () {
                        return wt(this._data)
                    }
                }, {
                    key: "element", get: function () {
                        return this._element
                    ...
                    key: "options", value: function () {
                        var t = {
                            ...
                            statusUploadSuccess: '<span class="slim-upload-status-icon"></span> Enregistré',
                        ...
                        return Wt.concat(Ot.Buttons).concat("rotate").forEach(function (e) {
                            var i = L(e);
        ...
        return function () {
            ...
            Wt.concat(Ot.Buttons).concat("rotate").forEach(function (t) {
                var e = L(t);
                f.forEach(function (t) {
                    d["button" + e + t] = o
                })
            }), Jt.supported = function () {
                ...
                var e, i, n, o = [];
                for (e = t.querySelectorAll(".slim:not([data-state])"), n = e.length; n--;) i = e[n], o.push(Jt.create(i, Jt.getOptionsFromAttributes(i)));
                return o
            }, Jt.getOptionsFromAttributes = function (t) {
                var e = m(t), i = {meta: {}};
                for (var n in e) {
                    var o = d[n], a = e[n];
                    o ? (a = o(a), a = null === a ? vt(Jt.options()[n]) : a, i[n] = a) : 0 === n.indexOf("meta") && (i.meta[I(n.substr(4))] = a)
                }
                return i
            }, Jt.find = function (t) {
                ...
                if (!Jt.find(t)) {
                    e || (e = Jt.getOptionsFromAttributes(t));
                    var n = new Jt(t, e);
                    return i.push(n), n
                }
